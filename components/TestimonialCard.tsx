    ...
    <section className="py-12 bg-gray-50 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          <div className="relative mt-10 md:mt-24 md:order-2 overflow-x-hidden">
            <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6 max-w-[calc(100%+0.5rem)] md:max-w-[calc(100%+1rem)]">
              <div
