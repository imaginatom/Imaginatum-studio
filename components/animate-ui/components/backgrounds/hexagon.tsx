...
function HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden dark:bg-neutral-900 bg-neutral-100 max-w-[100vw]',
        className,
      )}
      {...props}
    >
      <style>{`:root { --hexagon-margin: ${hexagonMargin}px; }`}</style>
      <div className="absolute top-0 -left-0 size-full overflow-hidden max-w-[100vw]">
